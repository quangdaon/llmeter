...
The quiz dataset lives in `src/lib/server/questions.json` — a JSON file committed with the project and loaded server-side. It is generated by the **[llmeter-interrogator](https://github.com/quangdaon/llmeter-interrogator)** CLI tool.
